...
async function main() {
  ...
  if (!existingUser) {
    ...
    const hashedPassword = await bcrypt.hash("Demo!234", 10);
    ...
    await Generation.insertMany([
      ...
      },
      {
        ...
        prompt:
          "Generate cinematic AI image prompts for a futuristic workspace.",
        output:
          "1. Futuristic workspace with neon lighting...",
        metadata: {
          category: "Technology",
          style: "Cinematic",
          mood: "Inspiring",
