    ...
    <main className="mx-auto flex min-h-screen max-w-3xl items-center px-4 py-16 sm:px-6 lg:px-8">
      <section className="w-full rounded-3xl border border-border bg-card p-8 shadow-sm sm:p-10">
        <div className="mb-8 space-y-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Welcome back to AI Content Studio</h1>
          <p className="text-sm leading-6 text-muted-foreground">
            Access your dashboard to generate AI content, manage history, and track usage.
          </p>
        </div>
        <LoginForm />
      </section>
